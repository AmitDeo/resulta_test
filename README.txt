...
This is a test plugin for Resulta. It uses the `WordPress Plugin Boilerplate(https://github.com/DevinVinson/WordPress-Plugin-Boilerplate)` to develop the plugin with OOP foundation.
